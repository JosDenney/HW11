...
In the code following, I will demonstrate completion of assignment 11. All the required code, as well as the output will be shown in this document.

The url for the GitHub repo for this project can be found at: https://github.com/JosDenney/HW11
...
![Volatility w/smoothing](C:\\Users\\jdenney\\Documents\\DataScience\\Wk11\\Volatility.png)



The volatility estimate with a decay factor of 100 still reflects the changes in the predicted data, but also smooths out the plot. 
